...
import 'package:licenta_georgebardas/screens/admin_screen/admin_orders_screen/admin_orders_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          AppLocalizations.of(context)?.admin_orders ?? "",
          style: TextStyle(
            fontSize: 20,
              ...
              children: [
                Expanded(
                  child: !state.isLoading
                      ? RefreshIndicator(
                          onRefresh: context.read<AdminOrdersCubit>().getOrders,
